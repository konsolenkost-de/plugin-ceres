<template>
    <div class="container-max mt-5">
            ...
            <div class="col-sm-10 offset-sm-1 col-md-6 offset-md-3">
                ...
                <div class="row">
                    <div class="col-sm-{% if 'my-account' not in backlink %}6{% else %}12{% endif %}"
                        :class="{ 'col-sm-6': !myAccountInBacklink, 'col-sm-12': myAccountInBacklink }">
        ...
        <div class="modal fade" ref="guestModal" tabindex="-1" role="dialog" aria-labelledby="modal-title"
            aria-modal="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 id="modal-title" class="modal-title">{{ $translate("Ceres::Template.loginOrderAsGuest") }}
                        </h3>
                        <button type="button" class="close" data-testing="guest-login-modal" data-dismiss="modal"
                            aria-hidden="true" :aria-label="$translate('Ceres::Template.closeIcon')">&times;</button>
                    </div>
