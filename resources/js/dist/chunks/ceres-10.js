...
var render = function render() {
  ...
  return _c("div", [_c("div", [!_vm.basketItems.length > 0 ? _c("div", [_c("div", {
    staticClass: "h5 py-3"
  }, [_vm._v("Du hast noch keine Artikel im Warenkorb.")])]) : _vm._e(), _vm._v(" "), _c("transition-group", {
    attrs: {
      name: "list-transition",
      tag: "div"
    }
  }, [_vm._l(_vm.basketItems, function (basketItem) {
    return [basketItem.price > 0 ? _c("basket-list-item", {
      key: basketItem.id,
      attrs: {
  ...
  })], 2), _vm._v(" "), _vm.basketItems.some(function (item) {
    return item.price <= 0;
  }) ? _c("div", [_vm._v("Gratis Artikel:")]) : _vm._e(), _vm._v(" "), _c("transition-group", {
    attrs: {
      name: "list-transition",
      tag: "div"
    }
...
var render = function render() {
  ...
  })], 2)], 1)]), _vm._v(" "), _vm.basketItem.price > 0 ? _c("div", {
