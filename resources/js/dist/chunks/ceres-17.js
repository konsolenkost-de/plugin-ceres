...
var render = function render() {
  ...
  return _c("form", {
  ...
  }, [_vm.showNameInputs ? _c("label", {
    attrs: {
      for: "email-input-id_" + _vm._uid
    }
  }, [_vm._v(_vm._s(_vm.$translate("Ceres::Template.newsletterEmail")) + " *")]) : _vm._e(), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.email,
    ...
    staticClass: "btn btn-block btn-primary btn-appearance newsletter-button",
    ...
    attrs: {
      width: "13",
      height: "13",
      src: "https://cdn02.plentymarkets.com/xp4oxtd91bsc/frontend/Images/Footer/Redesign/mail_white.png"
    }
  }), _c("span", {
    staticClass: "newsletter-button-text"
  }, [_vm._v("  Anmelden")])])])])])]);
};
var staticRenderFns = [];
