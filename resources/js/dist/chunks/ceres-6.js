  ...
  return _c("article", {
    ...
    return [_c("category-image-carousel", {
      ...
      attrs: {
        ...
        alt: _vm.item.texts.name2 + " " + _vm.item.texts.name3 + " kaufen",
        title: _vm.item.texts.name2 + " " + _vm.item.texts.name3 + " kaufen",
        "item-url": _vm._f("itemURL")(_vm.item, _vm.urlWithVariationId),
    ...
    return [_vm.item.prices.specialOffer && _vm.item.prices.default.price.value > _vm.item.prices.specialOffer.unitPrice.value || _vm.item.prices.rrp && _vm.item.prices.rrp.price.value > _vm.item.prices.default.unitPrice.value ? _c("img", {
      staticClass: "store-special",
      attrs: {
        src: "https://cdn02.plentymarkets.com/xp4oxtd91bsc/frontend/Images/Category/sale-category-item.png"
      }
    }) : _vm.item.item.condition.id === 0 ? _c("img", {
      staticClass: "store-special",
      attrs: {
        src: "https://cdn02.plentymarkets.com/xp4oxtd91bsc/frontend/Images/Category/neu-category-item.png"
      }
    }) : _vm._e()];
    ...
    return [_c("div", {
      ...
      staticClass: "category-item-name"
    }, [_vm._v(_vm._s(_vm._f("truncate")(_vm.item.texts.name2, "50")))]), _vm._v(" "), _c("span", {
      staticClass: "category-item-sub-name"
    }, [_vm._v(_vm._s(_vm._f("truncate")(_vm.item.texts.name3, "20")))])]), _vm._v(" "), _c("div", {
    ...
    }, [_vm.item.prices.specialOffer && _vm.item.prices.default.price.value > _vm.item.prices.specialOffer.unitPrice.value || _vm.item.prices.rrp && _vm.item.prices.rrp.price.value > _vm.item.prices.default.price.value ? [_c("span", {
      staticClass: "small"
    }, [_vm._v(_vm._s(_vm.trans("d2gPmThemeKonsolenkost::Theme.categoryItemOnlySale")))]), _vm._v(" "), _vm.item.prices.rrp.price.value > _vm.item.prices.default.unitPrice.value ? _c("del", {
      staticClass: "crossprice"
    }, [_vm._v("\n                                        " + _vm._s(_vm._f("itemCrossPrice")(_vm.item.prices.rrp.unitPrice.formatted)) + "\n                                    ")]) : _c("del", {
      staticClass: "crossprice"
    }, [_vm._v("\n                                        " + _vm._s(_vm._f("itemCrossPrice")(_vm.item.prices.default.unitPrice.formatted)) + "\n                                    ")])] : _vm._e()], 2), _vm._v(" "), _c("div", {
      staticClass: "price"
      ...
      staticClass: "small"
    }, [_vm._v(_vm._s(_vm.trans("d2gPmThemeKonsolenkost::Theme.categoryItemOnly")))]), _vm._v(" " + _vm._s(_vm._f("specialOffer")(_vm.item.prices.default.unitPrice.formatted, _vm.item.prices, "unitPrice", "formatted")) + "\n                                ")]], 2)])], 2), _vm._v(" "), _vm._t("after-prices")], 2), _vm._v(" "), _vm.item.prices.default.lowestPrice.value && _vm.hasCrossPrice ? _c("div", {
    ...
    }, [_c("span", [_vm._v(_vm._s(_vm.item.unit.content))]), _vm._v(" "), _c("span", [_vm._v(" " + _vm._s(_vm.item.unit.names.name))]), _vm._v(" "), _vm.item.variation.mayShowUnitPrice ? _c("span", [_vm._v(" | " + _vm._s(_vm.basePrice))]) : _vm._e(), _vm._v(" "), _c("span", {
      staticClass: "availability",
      class: "availability-" + _vm.item.variation.availability.id
    })]) : _vm._e(), _vm._v(" "), _c("add-to-basket", {
      attrs: {
        "variation-id": _vm.item.variation.id,
        "is-salable": !!_vm.item.filter && _vm.item.filter.isSalable,
        "has-children": !!_vm.item.item && _vm.item.item.salableVariationCount > 1,
    ...
    }, [_vm._v(_vm._s(_vm.$translate("Ceres::Template.itemShippingCosts")))]) : _c("a", [_vm._v(_vm._s(_vm.$translate("Ceres::Template.itemShippingCosts")))])])], 1)];
  })], 2)]);
};
var staticRenderFns = [];
render._withStripped = true;
