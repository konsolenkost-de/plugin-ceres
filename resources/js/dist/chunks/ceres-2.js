...
var render = function render() {
  ...
  return _c("div", [!_vm.showQuantity && _vm.useLargeScale && _vm.canBeAddedToBasket ? _c("div", {
  ...
  })], 1), _vm._v(" "), _c("add-to-wish-list-icon", {
    attrs: {
    ...
    staticClass: "btn btn-block btn-primary btn-basket btn-appearance disabled",
    ...
    staticClass: "btn btn-primary btn-basket btn-i-w btn-appearance mobile-width-button",
    class: {
      "no-pointer-events": _vm.isLoading
    },
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.$translate("Ceres::Template.singleItemAddToBasket")))])], 1) : _vm._e(), _vm._v(" "), !_vm.canBeAddedToBasket ? _c("button", {
    staticClass: "btn btn-primary btn-basket btn-appearance mobile-width-button",
    attrs: {
      type: "button"
    },
    on: {
